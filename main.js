var link = "www.themarker.com/misc/themarkersmartphoneapp/.premium-1";
var num;
...
document.writeln(result)
    ...
    document.writeln('<a href="README.txt" <button  class="btn"><i class="fa fa-download"></i> Download</button>')
